...
<body class="b" background="<%=path %>/images/bg.jpg">
<div class="lg" >
    <div class="container">
        <div class="col-md-12">
            <h1 class="margin-bottom-15" style="color: white;">姜戈名品</h1>
            <form class="form-horizontal templatemo-container templatemo-login-form-1 margin-bottom-30"
                    role="form" action="<%=path %>/login/login-admin" method="post">
                <div class="form-group">
                    <div class="col-xs-12">
                        <div class="control-wrapper">
                            ...
                            <input type="text" class="form-control" id="username" name= "account" placeholder="请输入用户名">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label style=" margin-left: 34px">联系姜戈团队：18370949034</label>
                        <div class="inline-block">
                            <a href="<%=path %>/index"  style=" margin-left: 158px;">姜戈官网</a>
                        </div>
                    </div>
                </div>
            </form>
